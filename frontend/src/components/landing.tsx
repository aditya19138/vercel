          ...
          <div className="space-y-4">
            ...
            <Button onClick={async () => {
              ...
              const interval = setInterval(async () => {
                const response = await axios.get(`${BACKEND_UPLOAD_URL}/status/${res.data.id}`);
      ...
      {deployed && <Card className="w-full max-w-md mt-8">
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <Input id="deployed-url" readOnly type="url" value={`http://${uploadId}.test.com:3001/index.html`} />
          </div>
          <br />
          <Button className="w-full" variant="outline">
            <a href={`http://${uploadId}.test.com:3001/index.html`} target="_blank">
              Visit Website
            </a>
          </Button>
        </CardContent>
